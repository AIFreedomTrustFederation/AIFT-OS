      ...
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        >
          ...
          <p className="font-mono text-sm text-white/40 max-w-2xl mx-auto">
            The operating system never skips steps. Like the torus, every end
            point is a new beginning. No beginning. No end. Only eternal
            circulation.
          </p>
        </motion.div>
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
            ...
            <div className="flex flex-col items-center text-center">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(0,221,136,0.2) 0%, transparent 70%)",
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl w-full">
          {[
            {
              label: "No Beginning",
              desc: "The cycle has no canonical start. Any node can begin an inspection.",
            },
            {
              label: "No End",
              desc: "Learn feeds back into Inspect. The field renews eternally.",
            },
            {
              label: "No Skipping",
              desc: "The operating system enforces the full sequence. Evidence gates each transition.",
            },
          ].map((n) => (
            <div
              key={n.label}
            ...
            >
              <p className="font-cinzel text-sm font-bold text-white/60 mb-2">
                {n.label}
              </p>
